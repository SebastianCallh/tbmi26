...
% 1 = dot cloud 1 99.4 %
% 2 = dot cloud 2 99% 5000 iter lr 0.01
...
W0 = randn(numHidden, size(Xtraining, 1)); % Change this, Initiate your weight matrix W
V0 = randn(size(Dt{1}, 1), numHidden + 1); % Change this, Initiate your weight matrix V
